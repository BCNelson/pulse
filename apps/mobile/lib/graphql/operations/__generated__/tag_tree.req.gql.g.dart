...
Serializer<GTagBySlugPathReq> _$gTagBySlugPathReqSerializer =
...
class _$GTagBySlugPathReqSerializer
    implements StructuredSerializer<GTagBySlugPathReq> {
  @override
  final Iterable<Type> types = const [GTagBySlugPathReq, _$GTagBySlugPathReq];
  @override
  final String wireName = 'GTagBySlugPathReq';

  @override
  Iterable<Object?> serialize(Serializers serializers, GTagBySlugPathReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GTagBySlugPathVars)),
      'operation',
      serializers.serialize(object.operation,
          specifiedType: const FullType(_i4.Operation)),
      'executeOnListen',
    ...
    if (value != null) {
      result
        ..add('optimisticResponse')
        ..add(serializers.serialize(value,
            specifiedType: const FullType(_i2.GTagBySlugPathData)));
    }
    value = object.updateCacheHandlerKey;
    if (value != null) {
      result
  ...
  @override
  GTagBySlugPathReq deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = GTagBySlugPathReqBuilder();
...
class _$GTagBySlugPathReq extends GTagBySlugPathReq {
  @override
  final _i3.GTagBySlugPathVars vars;
  @override
  final _i4.Operation operation;
  @override
  final String? requestId;
  @override
  final _i2.GTagBySlugPathData? Function(
      _i2.GTagBySlugPathData?, _i2.GTagBySlugPathData?)? updateResult;
  @override
  final _i2.GTagBySlugPathData? optimisticResponse;
  @override
  final String? updateCacheHandlerKey;
  @override
  final Map<String, dynamic>? updateCacheHandlerContext;
  ...
  factory _$GTagBySlugPathReq(
          [void Function(GTagBySlugPathReqBuilder)? updates]) =>
      (GTagBySlugPathReqBuilder()..update(updates))._build();

  _$GTagBySlugPathReq._(
      {required this.vars,
      required this.operation,
      this.requestId,
      this.updateResult,
      ...
      : super._();
  @override
  GTagBySlugPathReq rebuild(void Function(GTagBySlugPathReqBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GTagBySlugPathReqBuilder toBuilder() =>
      GTagBySlugPathReqBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GTagBySlugPathReq &&
        vars == other.vars &&
        operation == other.operation &&
        requestId == other.requestId &&
        updateResult == other.updateResult &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GTagBySlugPathReq')
          ..add('vars', vars)
          ..add('operation', operation)
          ..add('requestId', requestId)
          ..add('updateResult', updateResult)
...
class GTagBySlugPathReqBuilder
    implements Builder<GTagBySlugPathReq, GTagBySlugPathReqBuilder> {
  _$GTagBySlugPathReq? _$v;

  _i3.GTagBySlugPathVarsBuilder? _vars;
  _i3.GTagBySlugPathVarsBuilder get vars =>
      _$this._vars ??= _i3.GTagBySlugPathVarsBuilder();
  set vars(_i3.GTagBySlugPathVarsBuilder? vars) => _$this._vars = vars;
  ...
  _i2.GTagBySlugPathData? Function(
      _i2.GTagBySlugPathData?, _i2.GTagBySlugPathData?)? _updateResult;
  _i2.GTagBySlugPathData? Function(
          _i2.GTagBySlugPathData?, _i2.GTagBySlugPathData?)?
      get updateResult => _$this._updateResult;
  set updateResult(
          _i2.GTagBySlugPathData? Function(
                  _i2.GTagBySlugPathData?, _i2.GTagBySlugPathData?)?
  ...
  _i2.GTagBySlugPathDataBuilder? _optimisticResponse;
  _i2.GTagBySlugPathDataBuilder get optimisticResponse =>
      _$this._optimisticResponse ??= _i2.GTagBySlugPathDataBuilder();
  set optimisticResponse(_i2.GTagBySlugPathDataBuilder? optimisticResponse) =>
      _$this._optimisticResponse = optimisticResponse;
  ...
  GTagBySlugPathReqBuilder() {
    GTagBySlugPathReq._initializeBuilder(this);
  }

  GTagBySlugPathReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _vars = $v.vars.toBuilder();
      _operation = $v.operation;
  ...
  @override
  void replace(GTagBySlugPathReq other) {
    _$v = other as _$GTagBySlugPathReq;
  }

  @override
  void update(void Function(GTagBySlugPathReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GTagBySlugPathReq build() => _build();

  _$GTagBySlugPathReq _build() {
    _$GTagBySlugPathReq _$result;
    try {
      _$result = _$v ??
          _$GTagBySlugPathReq._(
            vars: vars.build(),
            operation: BuiltValueNullFieldError.checkNotNull(
                operation, r'GTagBySlugPathReq', 'operation'),
            requestId: requestId,
            updateResult: updateResult,
            optimisticResponse: _optimisticResponse?.build(),
            updateCacheHandlerKey: updateCacheHandlerKey,
            ...
            fetchPolicy: fetchPolicy,
            executeOnListen: BuiltValueNullFieldError.checkNotNull(
                executeOnListen, r'GTagBySlugPathReq', 'executeOnListen'),
            context: context,
          );
    } catch (_) {
      late String _$failedField;
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GTagBySlugPathReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
