...
abstract class GLoginData_login
  ...
  String get G__typename;
  String get token;
  _i2.GTime get expiresAt;
  GLoginData_login_viewer get viewer;
...
abstract class GLoginData_login_viewer
    implements Built<GLoginData_login_viewer, GLoginData_login_viewerBuilder> {
  GLoginData_login_viewer._();

  factory GLoginData_login_viewer(
          [void Function(GLoginData_login_viewerBuilder b) updates]) =
      _$GLoginData_login_viewer;

  static void _initializeBuilder(GLoginData_login_viewerBuilder b) =>
      b..G__typename = 'User';
  ...
  String? get email;
  static Serializer<GLoginData_login_viewer> get serializer =>
      _$gLoginDataLoginViewerSerializer;

  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GLoginData_login_viewer.serializer,
        this,
      ) as Map<String, dynamic>);

  static GLoginData_login_viewer? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(
        GLoginData_login_viewer.serializer,
        json,
      );
